...
export default function TeamScoreboard({ data }: TeamScoreboardProps) {
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto py-2 sm:py-8 px-1.5 sm:px-6 ${plusJakarta.className}`}>
      {/* ================================================================ */}
      {/* 1. MASTER COCKPIT ENCLOSURE (Awwwards Doppelrand Architecture) */}
      {/* ================================================================ */}
      <div className="relative rounded-[2rem] sm:rounded-[2.5rem] p-1.5 sm:p-3.5 bg-gradient-to-b from-white/[0.12] via-white/[0.04] to-transparent ring-1 ring-white/10 shadow-[0_30px_100px_rgba(0,0,0,0.9)] overflow-hidden">
        
        {/* Deep Vantablack Inner Core */}
        <div className="relative rounded-[calc(2rem-0.375rem)] sm:rounded-[calc(2.5rem-0.875rem)] bg-[#040508] overflow-hidden p-3.5 sm:p-8 md:p-12 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)]">
          ...
          <div className="absolute inset-0 pointer-events-none z-0">
            ...
            <div className="absolute -top-32 -left-32 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] bg-cyan-500/20 blur-[120px] sm:blur-[150px] rounded-full" />
            {/* Deep Right Solar Gold Glow */}
            <div className="absolute -top-32 -right-32 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] bg-amber-500/20 blur-[120px] sm:blur-[150px] rounded-full" />
          ...
          <div className="relative z-10 flex flex-col gap-6 sm:gap-12 items-center">
            
            {/* ========================================================== */}
            {/* 2. TOP TELEMETRY DECK & TITLE */}
            {/* ========================================================== */}
            <header className="flex flex-col items-center text-center space-y-2.5 sm:space-y-3 w-full">
              {/* Telemetry Status Bar */}
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
                <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-white/[0.04] border border-white/10 backdrop-blur-xl shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                  <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_8px_#34d399]" />
                  <span className={`text-[9px] sm:text-[11px] font-bold tracking-[0.2em] uppercase text-white/90 ${jetbrainsMono.className}`}>
                    OFFICIAL SQUAD TOURNAMENT
                  </span>
                </div>

                <div className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-amber-500/10 border border-amber-400/30 text-amber-300 backdrop-blur-xl">
                  <span className="material-symbols-outlined text-[13px] sm:text-[14px] text-amber-400">military_tech</span>
                  <span className={`text-[9px] sm:text-[11px] font-bold tracking-[0.15em] uppercase ${jetbrainsMono.className}`}>
                    SERIES IV
                  </span>
                </div>
              </div>
              ...
              {/* Subtitle Eyebrow */}
              <div className={`flex items-center justify-center gap-2 sm:gap-3 text-white/60 text-[11px] sm:text-sm font-semibold tracking-[0.2em] sm:tracking-[0.25em] uppercase pt-1 ${jetbrainsMono.className}`}>
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] items-center gap-4 sm:gap-6">
              ...
              {/* -------------------------------------------------------- */}
              <div className="relative rounded-[1.75rem] sm:rounded-[2rem] p-1 sm:p-1.5 bg-gradient-to-br from-cyan-400/30 via-blue-600/10 to-transparent ring-1 ring-cyan-400/30 shadow-[0_0_50px_rgba(6,182,212,0.15)] group transition-all duration-500 hover:shadow-[0_0_70px_rgba(6,182,212,0.25)]">
                <div className="rounded-[calc(1.75rem-0.25rem)] sm:rounded-[calc(2rem-0.375rem)] bg-gradient-to-br from-[#060D1A]/95 via-[#030812]/90 to-[#020408]/95 p-4 sm:p-7 flex flex-col gap-4 sm:gap-6 relative overflow-hidden backdrop-blur-xl">
                  ...
                  <div className="flex items-end justify-between pt-3 border-t border-cyan-500/20">
                    <div className="flex flex-col">
                      <span className={`text-[10px] sm:text-[11px] font-bold tracking-[0.15em] text-cyan-300/70 uppercase ${jetbrainsMono.className}`}>
                        SESSION SERIES
                      </span>
                      <span className={`text-[11px] sm:text-sm font-semibold text-white/70 mt-0.5 ${jetbrainsMono.className}`}>
                  ...
                  {/* Frag Gauge */}
                  <div className="flex items-center justify-between text-[11px] sm:text-xs text-cyan-300/70 pt-2 border-t border-white/[0.06]">
              ...
              <div className="flex flex-col items-center justify-center px-2 sm:px-6 py-2 my-auto">
                ...
                <div className="mt-2.5 sm:mt-3 flex flex-col items-center gap-1">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/[0.04] border border-white/10">
                    <span className="material-symbols-outlined text-[11px] sm:text-xs text-amber-400 animate-spin">
                      radar
                    </span>
                    <span className={`text-[8px] sm:text-[10px] font-bold tracking-[0.15em] text-white/80 uppercase ${jetbrainsMono.className}`}>
                      LIVE TELEMETRY
                    </span>
                  </div>
                </div>
                ...
                {/* Frag Balance Bar */}
                <div className="w-40 sm:w-56 mt-3 sm:mt-4 flex flex-col gap-1.5">
                  <div className={`flex justify-between text-[9px] sm:text-[10px] font-bold ${jetbrainsMono.className}`}>
              ...
              {/* -------------------------------------------------------- */}
              <div className="relative rounded-[1.75rem] sm:rounded-[2rem] p-1 sm:p-1.5 bg-gradient-to-bl from-amber-400/30 via-yellow-600/10 to-transparent ring-1 ring-amber-400/30 shadow-[0_0_50px_rgba(245,158,11,0.15)] group transition-all duration-500 hover:shadow-[0_0_70px_rgba(245,158,11,0.25)]">
                <div className="rounded-[calc(1.75rem-0.25rem)] sm:rounded-[calc(2rem-0.375rem)] bg-gradient-to-bl from-[#181104]/95 via-[#0F0B02]/90 to-[#050401]/95 p-4 sm:p-7 flex flex-col gap-4 sm:gap-6 relative overflow-hidden backdrop-blur-xl text-right">
                  {/* Subtle Top Inner Edge Highlight */}
                  ...
                  <div className="flex items-end justify-between pt-3 border-t border-amber-500/20 flex-row-reverse">
                    <div className="flex flex-col items-end">
                      <span className={`text-[10px] sm:text-[11px] font-bold tracking-[0.15em] text-amber-300/70 uppercase ${jetbrainsMono.className}`}>
                        SESSION SERIES
                      </span>
                      <span className={`text-[11px] sm:text-sm font-semibold text-white/70 mt-0.5 ${jetbrainsMono.className}`}>
                  ...
                  {/* Frag Gauge */}
                  <div className="flex items-center justify-between text-[11px] sm:text-xs text-amber-300/70 pt-2 border-t border-white/[0.06] flex-row-reverse">
                    <span className={jetbrainsMono.className}>TOTAL FRAGS</span>
            ...
            {/* ========================================================== */}
            <footer className="w-full flex flex-col items-center text-center pt-4 sm:pt-6 border-t border-white/10 space-y-2.5 sm:space-y-3">
              <span className={`text-[11px] sm:text-sm font-bold tracking-[0.25em] sm:tracking-[0.3em] uppercase text-white/60 ${jetbrainsMono.className}`}>
              ...
              <div className="inline-flex items-center gap-1.5 sm:gap-4 px-4 py-1.5 sm:px-5 sm:py-2 rounded-full bg-white/[0.04] border border-white/10 text-white/70 text-[9px] sm:text-xs font-semibold tracking-[0.15em] sm:tracking-[0.2em] uppercase backdrop-blur-md">
